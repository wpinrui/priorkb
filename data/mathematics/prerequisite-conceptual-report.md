...
This report records the final v3 conceptual-understanding vote. It does not add relationships, change votes, or resolve the three disputed pairs.
...
The packet accepts a classification at four of five votes. All 180 v3 votes were present before tallying.
...
| Pending user decision | 3 |

The three pending rows are disputed links. The full prerequisite graph remains unassessed. The source-inferred relationships are not official Ministry of Education prerequisite relations.
...
The user decision requested for these three links is whether each should be classified as helpful. The current tally remains pending until that decision is recorded.
